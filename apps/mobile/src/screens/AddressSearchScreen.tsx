...
function makeStyles(palette: Palette) {
  ...
  searchBox: { flex: 1, height: 52, borderRadius: 6, backgroundColor: palette.surface, borderWidth: 1, borderColor: palette.border, flexDirection: "row", alignItems: "center", paddingHorizontal: 11 },
  ...
  resultIcon: { width: 42, height: 42, borderRadius: 6, backgroundColor: "#E3F7EA", alignItems: "center", justifyContent: "center" },
  ...
  exampleChip: { borderRadius: 6, backgroundColor: palette.background, borderWidth: 1, borderColor: palette.border, paddingHorizontal: 11, paddingVertical: 8 },
