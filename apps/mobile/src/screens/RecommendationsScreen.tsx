...
const styles = StyleSheet.create({
  ...
  fairScore: { width: 74, height: 74, borderRadius: 8, backgroundColor: colors.mint, alignItems: "center", justifyContent: "center" },
  ...
  mapLegend: { position: "absolute", alignSelf: "center", bottom: 10, backgroundColor: colors.surface, paddingHorizontal: 11, paddingVertical: 6, borderRadius: 5 },
  ...
  metricRow: { flexDirection: "row", marginTop: 16, backgroundColor: colors.background, borderRadius: 6, paddingVertical: 11 },
