...
function makeStyles(palette: Palette) {
  ...
  editorSheet: { backgroundColor: palette.surface, borderTopLeftRadius: 8, borderTopRightRadius: 8, padding: 22, alignItems: "center", gap: 12 },
  ...
  adjustButton: { width: 44, height: 40, borderRadius: 6, backgroundColor: palette.primarySoft, alignItems: "center", justifyContent: "center" },
  adjustPressed: { opacity: 0.7 },
  adjustText: { color: palette.primary, fontSize: 22, fontWeight: "900" },
  resetButton: { width: 72, height: 40, borderRadius: 6, backgroundColor: palette.background, alignItems: "center", justifyContent: "center" },
