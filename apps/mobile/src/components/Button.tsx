...
function useStyles() {
  ...
  return useMemo(
    () =>
      StyleSheet.create({
        button: { minHeight: 46, borderRadius: 12, paddingHorizontal: 16, alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 8, borderWidth: 1, borderColor: "transparent", shadowColor: palette.charcoal, shadowOpacity: 0.045, shadowRadius: 7, shadowOffset: { width: 0, height: 2 } },
        compactButton: { minHeight: 38, alignSelf: "flex-start", paddingHorizontal: 12 },
        primaryButton: { backgroundColor: palette.primary },
        secondaryButton: { backgroundColor: palette.surface, borderColor: palette.border },
        softButton: { backgroundColor: palette.primarySoft },
        hovered: { shadowOpacity: 0.1, transform: [{ translateY: -1 }] },
        focused: { borderColor: palette["border-strong"], shadowColor: palette.primary, shadowOpacity: 0.28, shadowRadius: 5 },
        pressed: { opacity: 0.88, transform: [{ scale: 0.98 }] },
        disabled: { opacity: 0.58 },
        buttonText: { fontSize: 16, fontWeight: "800" },
        compactButtonText: { fontSize: 13 },
        primaryButtonText: { color: palette["primary-contrast"] },
        secondaryButtonText: { color: palette.text },
        softButtonText: { color: palette.primary },
        buttonIcon: { width: 26, height: 26, borderRadius: 13, backgroundColor: palette["focus-ring"], alignItems: "center", justifyContent: "center" },
        buttonIconLight: { backgroundColor: palette.surface },
        buttonIconText: { color: palette["primary-contrast"], fontSize: 13, fontWeight: "900" },
